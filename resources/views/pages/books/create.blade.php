            ...
            <div class="col-md-8">
                <div class="card mt-2">
                    <div class="card-header">
                        <div class="h2 text-center p-3">Create a new Book</div>
                    </div>
                    <div class="card-body p-5">
                        <form action="{{ route('book.store') }}" method="post" id="bookForm">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="book_name" id="book_name" class="form-control"
                                                onblur="validateBookData(book_name)" oninput="validateBookData(book_name)">
                                    ...
                                    <div class="form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="book_author" id="book_author" class="form-control"
                                                onblur="validateBookData(book_author)"
                                    ...
                                    <div class="form">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" name="book_price" id="book_price"
                                                class="form-control" onblur="validateBookData(book_price)"
                                    ...
                                    <div class="form">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" name="book_qtt" id="book_qtt"
                                                class="form-control" onblur="validateBookData(book_qtt)"
                                                oninput="validateBookData(book_qtt)">
                                    ...
                                    <div class="form">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control" name="category_id" id="category_id"
                                                ...
                                                <option value="0" disabled selected>Select from the list</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 d-flex mt-3">
                                    <button class="btn btn-secondary mx-2"  onclick="clearForm()" id="clear">Clear</button>
                                    <button class="btn btn-success mx-2 " id="addData">Add Book Data</button>
                                </div>
                            </div>
                        </form>
                    </div>
